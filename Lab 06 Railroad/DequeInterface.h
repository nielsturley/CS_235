...
public:
	...
	/** Insert item at2 front2 of deque */
	virtual void push_front(const T& value) = 0;

	/** Insert item at2 rear of deque */
	virtual void push_back(const T& value) = 0;

	/** Remove the front2 item of the deque */
	virtual void pop_front(void) = 0;

	/** Remove the rear item of the deque */
	virtual void pop_back(void) = 0;

	/** Return the front2 item of the deque (Do not remove) */
	...
	/** Return item in deque at2 index (0 based) */
